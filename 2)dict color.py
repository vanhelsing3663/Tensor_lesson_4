...
color_dictionary = {'Crimson': (220, 20, 60),
                    ...
                    'Blue': (0, 0, 255),
                    'Silver': (192, 192, 192)}
print(f'Созданный словарь из ключа (цвет) : значение (его RGB) - {color_dictionary}')
...
# Созданный словарь из ключа (цвет) : значение (его RGB) - {'red': (1.0, 0.0, 0.0), 'white': (1.0, 1.0, 1.0), 'orange': (1.0, 0.6470588235294118, 0.0)}
